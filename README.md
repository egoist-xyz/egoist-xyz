...
Cześć! Jestem **eg0ist**. Moja przygoda z programowaniem zaczęła się w 2020 roku "dla śmiechu", ale szybko przerodziła się w prawdziwą zajawkę. Od początku 2021 roku nieustannie się uczę, tworząc coraz bardziej zaawansowane projekty.

- 🔭 **Aktualnie pracuję nad:** Autorskimi skryptami dla projektu **Sfera RP** (LUA/FiveM).
- 🚀 **Mój cel:** Tworzenie unikalnych rozwiązań, których nikt wcześniej nie zbudował.
- 💻 **Specjalizacja:** Ekosystem JavaScript (Node.js, React) oraz web development.
